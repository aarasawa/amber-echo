...
<code>=</code> is an equality operator to compare a column value to a specific value. <br>
<code>IN</code> is a set membership operator to compare a column value.<br>
<code>LIKE</code> is a pattern matching operator for filtering rows based on partial matches.
